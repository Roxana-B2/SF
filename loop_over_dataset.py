...
show_only_frames = [0, 200]  # [65, 100]  # [150, 200]  # show only frames in interval for debugging
...
configs_det.lim_y = [-25, 25]  # [-5, 15]  # [-5, 10]
